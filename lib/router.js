...
const getRouter = (options) => {
  ...
  router.get('/callback', async function (req, res, next) {
    ...
    try {
      ...
      res.redirect(`${returnUrl}?space_id=${space_id}&external_api_key_staging=${options.external_api_key_staging}&external_api_key_production=${options.external_api_key_prod}`)
    } catch (e) {
      console.log(e)
